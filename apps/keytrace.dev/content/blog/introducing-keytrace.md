...
- The data is created so that Keytrace can offer an API which only requires GET requests and the capacity to validate a [JSON Web Key](https://datatracker.ietf.org/doc/html/rfc7517) to prove that the data is 100% verified by Keytrace
